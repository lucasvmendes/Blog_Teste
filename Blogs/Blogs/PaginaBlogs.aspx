...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p> <asp:Button CssClass="btn #1565c0 blue darken-2" ID="btnCriarPost" runat="server" Text="Criar post" OnClick="btnCriarPost_Click" />
     ...
     <p class="center-align"> 
         <asp:LinkButton Cssclass="tooltipped" data-position="left" data-tooltip="Exportar dados" ID="LinkbtnDados" runat="server" OnClick="LinkbtnDados_Click">
         <i  class="small material-icons" style="color:grey">fast_forward</i></asp:LinkButton></p>
     <p class="center-align"> 
     ...
     <p class="green-text"> <asp:Label ID="lblExportado" runat="server" Text="Exportado!" Visible="False"></asp:Label></p>
    </div>
