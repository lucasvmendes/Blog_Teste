...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="lbl-align alinhamento2">
        <p> <asp:Label CssClass="lbl-ne lbl-size" ID="lblBlog" runat="server" Text="Blog"></asp:Label></p>
        <p> <asp:Label ID="lblNomeBlog" runat="server" Text="Label"></asp:Label></p>
        <p> <asp:Label CssClass="lbl-ne lbl-size" ID="Label1" runat="server" Text="Tema"></asp:Label></p>
        <p> <asp:Label ID="lblTemaBlog" runat="server" Text="Label"></asp:Label></p>
        <p> <asp:Label CssClass="lbl-ne lbl-size" ID="lblPost" runat="server" Text="Post"></asp:Label></p>
        <p> <asp:Label ID="lblNomePost" runat="server" Text="Label"></asp:Label></p>
        <p> <asp:Label CssClass="lbl-ne lbl-size" ID="lblDescPost" runat="server" Text="Descrição"></asp:Label></p>
    ...
    <div class="row">
        ...
        <p class="lbl-align red-text"> <asp:Label ID="lblBranco" runat="server" Text="Campo não preenchido!" Visible="false"></asp:Label></p>
        <p>
